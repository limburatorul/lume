...
function buildTray() {
  ...
  tray.setContextMenu(
    Menu.buildFromTemplate([
      ...
      { label: 'Lume website', click: () => void shell.openExternal('https://protagonistlabs.app/lume/?utm_source=app&utm_medium=lume') },
      { label: 'More apps from Protagonist Labs', click: () => void shell.openExternal('https://protagonistlabs.app/?utm_source=app&utm_medium=lume') },
      { type: 'separator' },
